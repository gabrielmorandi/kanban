...
function BoardDetails({ board, data, theme }) {
  ...
  if (board) {
    return (
      <>
        ...
        {isPopUpOpen && <PopUp type="EditTask" onClose={closePopUp} data={data} taskName={taskName} taskDescr={taskDescription} selectBoard={board} status={status} theme={theme} />}
      </>
    )
  } else {
    return (
